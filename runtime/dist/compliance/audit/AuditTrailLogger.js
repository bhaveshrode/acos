...
export class AuditTrailLogger {
    ...
    log(record) {
        ...
        const signedRecord = new AuditRecord(record.actorId, record.actorType, record.tenantId, record.action, record.resource, record.eventId, record.correlationId, record.causationId, record.policy, record.authorization, record.result, record.timestamp, sig);
