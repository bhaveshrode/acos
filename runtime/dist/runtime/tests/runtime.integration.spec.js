...
describe.sequential("ACOS Phase 14 — Master Runtime & Product Assembly Integration Suite", () => {
    ...
    backendMediator.registerHandler(CreateInvoiceCommand, {
        handle: async (req) => ApplicationResult.success({
    ...
    it("should execute a complete E2E system commerce journey from frontend down to audit logging (RT18)", async () => {
        ...
        const compCtx = new ComplianceContext(actorClaims.userId, "human", actorClaims.organizationId, "CREATE_INVOICE", invoiceId, traceCtx.correlationId, traceCtx.causationId);
        ...
        const auditRecord = new AuditRecord(actorClaims.userId, "human", actorClaims.organizationId, "SUBMIT_PAYMENT", invoiceId, traceCtx.eventId, traceCtx.correlationId, traceCtx.causationId, "policy_standard", "token_auth0_valid", "SUCCESS");
