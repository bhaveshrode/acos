...
export class PaymentDataBoundary {
  private readonly classifier = new SensitiveFieldClassifier();
  private readonly masker = new DataMasker();

  public enforce(payload: Record<string, any>): Record<string, any> {
